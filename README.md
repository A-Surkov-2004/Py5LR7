Была написана программа с использованием шаблона "Наблюдатель", позволяющая отслеживать курсы валют. Использование фреймворка Flask позволило развернуть веб-интерфейс на локальном хосте.
